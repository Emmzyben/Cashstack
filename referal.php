...
// Update the user's balance, referralBonus, and referral_count
$updateSql = "UPDATE users SET balance = balance + ?, referalBonus = referalBonus + ?, referral_count = referral_count + ? WHERE id = ?";
$stmt = $conn->prepare($updateSql);
$stmt->bind_param("iiii", $referralBonus, $referralBonus, $packageReferralCount, $userId);
if ($stmt->execute()) {
    // Successfully updated balance, referral bonus, and count
} else {
