                      ...
                      <?php if (isset($userDetails)): ?>
                        <div class="card-body">
                          ...
                          <div id="balance">
                             ...
                             <div>
                             <h6 class="card-title text-nowrap mb-1" style="color:#fff">Balance: ₦<span class="counter" data-target="<?php echo htmlspecialchars($userDetails['balance']); ?>"><?php echo htmlspecialchars($userDetails['balance']); ?></span></h6>
